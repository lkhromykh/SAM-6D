...
def get_parser():
    ...
    parser.add_argument("--seg_path", required=True, help="Path to segmentation information(generated by ISM)")
...
def get_test_data(rgb_path, depth_path, cam_path, cad_path, seg_path, det_score_thresh, cfg):
    ...
    radius = np.max(np.linalg.norm(mesh.vertices, axis=1))
...
if __name__ == "__main__":
    ...
    with open(os.path.join(f"{cfg.output_dir}/sam6d_results", 'detections_pem.json'), "w") as f:
